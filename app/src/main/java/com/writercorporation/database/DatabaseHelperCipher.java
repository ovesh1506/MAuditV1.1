...
/**
 * Created by priyanka.nandkar on 4/11/2017.
 */

public class DatabaseHelperCipher extends OrmLiteSqliteOpenHelper {

    // name of the database file for your application
    private static final String DATABASE_NAME = "MAudit.db";
    ...
    public DatabaseHelperCipher(Context context,String password) {
